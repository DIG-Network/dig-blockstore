...
| STR-002 | gap | Module Hierarchy | Verify all listed source files exist at expected paths. `cargo check` must compile the full module tree without missing-module errors. |

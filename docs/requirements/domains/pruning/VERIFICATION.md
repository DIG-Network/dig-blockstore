...
| PRN-003 | gap | Compaction filter drops entries from CF_BLOCKS, CF_HEADERS, CF_ATTESTED below min_retained_height | Integration: enable compaction pruning; set min_retained_height; trigger compaction; verify entries below threshold removed. |
